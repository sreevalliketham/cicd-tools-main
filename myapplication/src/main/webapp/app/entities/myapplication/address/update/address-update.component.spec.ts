...
describe('Address Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Address query and add missing value', () => {
      ...
      const onetoone: IAddress = { id: 7567 };
      address.onetoone = onetoone;

      const addressCollection: IAddress[] = [{ id: 29505 }];
      jest.spyOn(addressService, 'query').mockReturnValue(of(new HttpResponse({ body: addressCollection })));
      const additionalAddresses = [onetoone];
    ...
    it('Should update editForm', () => {
      const address: IAddress = { id: 456 };
      const onetoone: IAddress = { id: 18372 };
      address.onetoone = onetoone;

      activatedRoute.data = of({ address });
      comp.ngOnInit();

      expect(comp.addressesSharedCollection).toContain(onetoone);
