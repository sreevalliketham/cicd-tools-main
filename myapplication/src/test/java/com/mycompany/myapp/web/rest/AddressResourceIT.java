...
class AddressResourceIT {
    ...
    private static final String DEFAULT_CITI = "AAAAAAAAAA";
    private static final String UPDATED_CITI = "BBBBBBBBBB";
    ...
    public static Address createEntity(EntityManager em) {
        Address address = new Address().aid(DEFAULT_AID).street(DEFAULT_STREET).citi(DEFAULT_CITI);
        return address;
    }
    ...
    public static Address createUpdatedEntity(EntityManager em) {
        Address address = new Address().aid(UPDATED_AID).street(UPDATED_STREET).citi(UPDATED_CITI);
        return address;
    }
    ...
    void createAddress() throws Exception {
        ...
        assertThat(testAddress.getAid()).isEqualTo(DEFAULT_AID);
        assertThat(testAddress.getStreet()).isEqualTo(DEFAULT_STREET);
        assertThat(testAddress.getCiti()).isEqualTo(DEFAULT_CITI);
    }
    ...
    void getAllAddresses() throws Exception {
        ...
        restAddressMockMvc
            ...
            .andExpect(jsonPath("$.[*].citi").value(hasItem(DEFAULT_CITI)));
    }
    ...
    void getAddress() throws Exception {
        ...
        restAddressMockMvc
            ...
            .andExpect(jsonPath("$.citi").value(DEFAULT_CITI));
    }
    ...
    void putExistingAddress() throws Exception {
        ...
        updatedAddress.aid(UPDATED_AID).street(UPDATED_STREET).citi(UPDATED_CITI);
        ...
        Address testAddress = addressList.get(addressList.size() - 1);
        assertThat(testAddress.getAid()).isEqualTo(UPDATED_AID);
        assertThat(testAddress.getStreet()).isEqualTo(UPDATED_STREET);
        assertThat(testAddress.getCiti()).isEqualTo(UPDATED_CITI);
    }
    ...
    void partialUpdateAddressWithPatch() throws Exception {
        ...
        partialUpdatedAddress.aid(UPDATED_AID).street(UPDATED_STREET);
    ...
    void fullUpdateAddressWithPatch() throws Exception {
        ...
        partialUpdatedAddress.aid(UPDATED_AID).street(UPDATED_STREET).citi(UPDATED_CITI);
